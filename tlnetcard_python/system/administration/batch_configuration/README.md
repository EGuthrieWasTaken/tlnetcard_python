...
|:---------------------------------------------------------:|:----------------------------------------------------------------------:|
|                ```__init(login_object)__```               |               Initializes the BatchConfiguration object.              |
|         ```download_snmp_configuration(path=None)```        |  Downloads the SNMP configuration and saves it to the specified file.  |
|        ```download_system_configuration(path=None)```       | Downloads the system configuration and saves it to the specified file. |
|   ```upload_snmp_configuration(path="snmp_config.ini")```   |             Uploads the specified SNMP configuration file.             |
| ```upload_system_configuration(path="system_config.ini")``` |            Uploads the specified system configuration file.            |
